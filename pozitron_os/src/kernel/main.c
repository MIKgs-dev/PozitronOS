...
static void create_showcase_window(void) {
    ...
    wg_create_checkbox(win, "Option 1", left_col, current_y, 1);
    wg_create_checkbox(win, "Option 2", left_col, current_y + 0.04f, 0);
    wg_create_checkbox(win, "Option 3", left_col, current_y + 0.08f, 0);
    ...
    current_y += 0.02f;
    wg_create_slider(win, center_col, current_y, 0.25f, 0.03f, 0, 100, 50);
    ...
    current_y += 0.04f;
    wg_create_progressbar(win, center_col, current_y, 0.25f, 0.03f, 60);
    
    current_y += 0.05f;
    wg_create_button(win, "Update", center_col, current_y, 0.15f, 0.04f,
    ...
    wg_create_input(win, left_col, bottom_y + 0.04f, 0.30f, 0.04f, "Type here...");
    wg_create_input(win, left_col, bottom_y + 0.09f, 0.30f, 0.04f, "Password");
    wg_create_input(win, left_col, bottom_y + 0.14f, 0.30f, 0.04f, "Long text for scrolling demo");
    
    wg_create_button(win, "Close Window", 0.70f, 0.85f, 0.25f, 0.05f,
                    close_demo_window, win);
    
    serial_puts("[DEMO] Showcase window created successfully\n");
    serial_puts("[DEMO] Press F1 to open this window again, F2 for test notifications\n");
}
